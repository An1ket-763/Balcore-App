  ...
  return (
    <>
      ...
      <div className="topnav">
        ...
        <a className="m-brand" href="#" aria-label="Balcore home">
          <img src={LOGO} width="24" height="24" alt="" />
          <span className="mb-name">Balcore</span>
        </a>
        <div className="search-bar">
          <svg className="search-ic" width="16" height="16" viewBox="0 0 17 17" fill="none">
          ...
          <input
            ...
            aria-label="Search assets and pools"
            autoComplete="off"
            role="combobox"
            aria-expanded="false"
            aria-controls="cmdkMenu"
          />
        ...
        <div className="top-actions">
          ...
          >
            <svg width="15" height="15" viewBox="0 0 17 17" fill="none">
              <path
                d="M1.6 12.4h13.8M5 12.4V3.8M12 12.4V3.8M5 4.6q3.5 4.6 7 0M1.6 8.6 5 5.4M15.4 8.6 12 5.4"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <span className="btn-label">Bridge</span>
          </button>
